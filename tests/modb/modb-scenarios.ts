...
export const MODB_SCENARIOS: readonly ModbScenario[] = [
  ...
  },
  {
    ...
    aml: 'cancelled',
    cancel: { code: NOT_PASSED, message: 'mrz_match completed with outcome failed' },
  ...
  },
  {
    ...
    aml: 'cancelled',
    cancel: { code: NOT_PASSED, message: 'mrz_match completed with outcome review' },
  ...
  },
  {
    ...
    aml: 'cancelled',
    cancel: { code: NOT_COMPLETED, message: 'mrz_match ended failed' },
