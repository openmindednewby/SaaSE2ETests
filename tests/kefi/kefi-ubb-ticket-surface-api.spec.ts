/**
 * Kefi TICKET SURFACE E2E (API tier) — the one page an attendee keeps.
 *
 * Split out of `kefi-ubb-ticket-surface.spec.ts` (max-file-lines) — see that
 * file's sibling `kefi-ubb-ticket-surface-ui.spec.ts` for the browser-render half.
 *
...
test.describe('Kefi UBB ticket surface (API)', () => {
